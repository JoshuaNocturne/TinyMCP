...
static constexpr const char* METHOD_NOTIFICATION_PROGRESS =
...
static constexpr const char* ERROR_MESSAGE_INVALID_REQUEST =
  u8"invalid request";
static constexpr const char* ERROR_MESSAGE_METHOD_NOT_FOUND =
  u8"method not found";
